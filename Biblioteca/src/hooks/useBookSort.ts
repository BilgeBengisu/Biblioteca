...
export function useBookSort(sortOrder: SortOption) {
    ...
    // Select the appropriate query result based on the sort order
    const { data, loading, error } = { popularidad: popularity, tendencias: trending, aleatorio: shuffle }[sortOrder];
